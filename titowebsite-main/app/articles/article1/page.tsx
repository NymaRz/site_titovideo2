        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap justify-center">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl normal-case leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                Les étapes nécessaires pour réaliser une bonne vidéo 
                </h2>
