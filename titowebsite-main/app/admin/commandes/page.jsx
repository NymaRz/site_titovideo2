...
export default function BasicTable() {
    ...
    const confirmUpdate = async () => {
        ...
        if (data && data.updatedCommande) {
            setCommandes((prevCommandes) => prevCommandes.map((commande) => commande._id === selectedCommandeId ? {
                ...commande,
                etat: updateEtat
            } : commande));
        }
    ...
    const confirmDelete = async () => {
        ...
        setCommandes((prevCommandes) => prevCommandes.filter((commande) => commande._id !== selectedCommandeId));
    ...
    return (<>
        ...
        <section id="portfolio" className="relative z-10 py-16 md:py-20 lg:py-28">
            ...
            <div className="container mx-auto text-center mb-7 pr-7 d-flex justify-content-center">
                <Link href="/admin/commandes_encours" passHref>
